...
\date{July 21, 2022}		% Here you can change the date presented in the paper title
...
\section{A Noise Model for Adders}
\input{noisy_adders.tex}

% \section{k--Redundant Approximate Adders}
% \input{redundant_adders.tex}
